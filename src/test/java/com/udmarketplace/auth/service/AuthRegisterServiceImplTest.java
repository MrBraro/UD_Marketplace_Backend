/**
 * Pruebas unitarias extras para AuthServiceImpl.
 * Verifica que el sistema detecte si alguien es menor de edad, exija PDF de autorización cuando corresponde, asocie ese PDF al usuario y guarde la contraseña cifrada en lugar de texto plano.
 *
 * @version 1.1
 * @since 2026-05-28
 */
...
@DisplayName("AuthRegisterServiceImplTest")
